...
* chore: Add lint and govulncheck to Taskfile by @Allaman
* build(deps): bump github.com/testcontainers/testcontainers-go from 0.41.0 to 0.42.0 by @dependabot[bot] in [#21](https://github.com/Allaman/chkRedis/pull/21)
* ci: Add lint and govulncheck by @Allaman
* build(deps): bump github.com/redis/go-redis/v9 from 9.17.3 to 9.18.0 by @dependabot[bot] in [#20](https://github.com/Allaman/chkRedis/pull/20)
* build(deps): bump github.com/testcontainers/testcontainers-go from 0.31.0 to 0.41.0 by @dependabot[bot] in [#19](https://github.com/Allaman/chkRedis/pull/19)
* build(deps): bump github.com/alecthomas/kong from 1.14.0 to 1.15.0 by @dependabot[bot] in [#18](https://github.com/Allaman/chkRedis/pull/18)
* ci: Add gomod dependabot by @Allaman
* ci: Add changelog action by @Allaman
* chore: Update Taskfile by @Allaman
* build(deps): bump goreleaser/goreleaser-action from 6 to 7 by @Allaman in [#17](https://github.com/Allaman/chkRedis/pull/17)
* build(deps): bump goreleaser/goreleaser-action from 6 to 7 by @dependabot[bot]
* docs: Update Screenshot by @Allaman
* docs: Update CHANGELOG by @Allaman

**Full Changelog**: https://github.com/Allaman/chkRedis/compare/1.1.2...1.1.3
